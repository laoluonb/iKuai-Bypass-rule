...
| `Proxy.yaml` | - | [下载](Proxy.yaml_isp.txt) / [Raw](https://raw.githubusercontent.com/laoluonb/iKuai-Bypass-rule/main/data/blackmatrix7/Proxy/Proxy.yaml_isp.txt) |
...
| `Proxy_No_Resolve.yaml` | - | [下载](Proxy_No_Resolve.yaml_isp.txt) / [Raw](https://raw.githubusercontent.com/laoluonb/iKuai-Bypass-rule/main/data/blackmatrix7/Proxy/Proxy_No_Resolve.yaml_isp.txt) |
