...
| 规则名称 | 域名格式 | ISP/IP 格式 |
| --- | --- | --- |
| `all` | [下载](all_domain.txt) / [Raw](https://raw.githubusercontent.com/laoluonb/iKuai-Bypass-rule/main/data/blackmatrix7/all_domain.txt) | [下载](all_isp.txt) / [Raw](https://raw.githubusercontent.com/laoluonb/iKuai-Bypass-rule/main/data/blackmatrix7/all_isp.txt) |
