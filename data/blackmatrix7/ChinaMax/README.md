...
| `ChinaMax_IP.yaml` | - | [下载](ChinaMax_IP.yaml_isp.txt) / [Raw](https://raw.githubusercontent.com/laoluonb/iKuai-Bypass-rule/main/data/blackmatrix7/ChinaMax/ChinaMax_IP.yaml_isp.txt) |
